                    ...
                    "patches": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "range_hash": {
                                    "type": "string",
                                    "description": "Hash of the content being replaced. it should get from get_text tool with the same start and end.",
                                },
                            },
